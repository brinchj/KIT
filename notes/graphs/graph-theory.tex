...
\begin{example}Til DR Byen og tilbage igen\end{example}
...
Vejen indeholder nu kun 2 knuder (3 mindre). Desværre kan den direkte
forbindelse kun bruges i en retning, så tilbagevejen bliver noget
længere:\\\indent
Kongens Nytorv $\to$ Christianshavn $\to$ Islands Brygge $\to$ DR Byen

Sammensættes de to veje fås cyklen:\\\indent
...
Indtil nu har vi kun beskæftiget os med uvægtede grafer. En vægtet
graf tildeler hver kant en \textit{vægt}, der angiver hvor meget
kanten "`koster"'. Man kan tænke på det som en afstand mellem de to
knuder kanten forbinder.
